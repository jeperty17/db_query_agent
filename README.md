...
**Test result:** 126 of the 126 cases in `docs/test-matrix.md` pass on the
last full run.
...
`gemini-3.1-flash-lite` passes the full 126-case matrix in `docs/test-matrix.md`
within a single day's free-tier quota.
